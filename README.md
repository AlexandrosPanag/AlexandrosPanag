...
Tools       →   Git  Docker  Linux  Azure
AI / ML     →   RAG Design  LLM Integration  TinyLlama  Qwen
Embedded    →   Arduino  ESP32  Raspberry Pi Pico  Texas Instruments
```
...
- **[Java Projects](https://github.com/AlexandrosPanag/My_Java_Projects)** — cross-platform solutions
